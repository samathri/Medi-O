                ...
                <div class="col-md-6 col-12 mb-4 mb-md-0">
                    <div class="item-images">
                        <?php if (!empty($imagePaths[0])): ?>
                            <img src="<?= htmlspecialchars(trim($imagePaths[0])) ?>" alt="Product Image"
                                class="img-fluid mb-3" id="mainImage" />
                        <?php else: ?>
                        ...
                        <div class="item-thumbnails d-flex flex-wrap gap-2">
                            <?php foreach ($imagePaths as $path): ?>
                                ...
                                <?php if (!empty($cleanedPath)): ?>
                                    <img src="<?= $cleanedPath ?>" alt="Thumbnail" class="img-fluid thumbnail"
                                        style="width: 70px; cursor: pointer;" onclick="changeImage(this)" />
                                <?php endif; ?>
                            <?php endforeach; ?>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="item-info">
                        ...
                        <p><strong>Stock:</strong>
                            <?= $stock > 0 ? $stock : "<span class='text-danger'>Out of Stock</span>" ?></p>
                        ...
                        <div class="d-flex justify-content-start  ">
                            ...
                            <form action="buy-now.php" method="POST" class="buy-now">
                                ...
                                <button type="submit" class="btn btn-success " <?= $stock <= 0 ? 'disabled' : '' ?>>Buy
                                    Now</button>
                            </form>
