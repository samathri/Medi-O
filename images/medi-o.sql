...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2025 at 04:54 PM
...
CREATE TABLE `prescriptions` (
  ...
  `status` enum('Pending','Reviewed','Approved','Assigned','Ready','Collected') DEFAULT 'Pending',
...
(14, 'baka baka', 'deka deka deka', 123.00, 12, 'modaya', 'uploads/photo-1590272456521-1bbe160a18ce.png,uploads/Blue and White Flat Illustrative Health Products Logo.png,uploads/medi-o-logo.png', '2025-08-02 11:19:36'),
(16, 'baka baka', 'deka deka deka', 123.00, 12, 'modaya', 'uploads/photo-1590272456521-1bbe160a18ce.png,uploads/Blue and White Flat Illustrative Health Products Logo.png,uploads/medi-o-logo.png', '2025-08-02 11:19:54');
...
(4, 'Samathri Abhayapala', 'admin@gmail.com', '$2y$10$S/GZtVmFRpp/zRLuELcLuO8Wmb6ceJuhZNK.DprNyac2ZOod6atH2', '0767170438', 'adfjlfdj jdflaj asjfl', 'admin', '2025-08-01 15:51:11', '3b727a0a88228a89282f0379dd619e29a0951a6aec3a99cd4ed16aceff0917d0', '2025-08-01 23:33:41'),
...
ALTER TABLE `prescriptions`
  ...
  ADD CONSTRAINT `prescriptions_ibfk_3` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`);
COMMIT;
